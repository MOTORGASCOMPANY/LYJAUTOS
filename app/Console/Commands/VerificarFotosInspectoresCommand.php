...
class VerificarFotosInspectoresCommand extends Command
{
    ...
    public function handle()
    {
        ...
        // RANGO FIJO CON INICIO Y FIN EXACTOS
        $inicio = Carbon::parse('2026-01-01')->startOfDay();
        $fin = Carbon::parse('2026-01-15')->endOfDay();

        $this->info("Verificando expedientes desde {$inicio} hasta {$fin}...");
        ...
        try {
            ...
            $agrupados = $this->agruparExpedientesIncompletosPorInspector([
                ...
                //'ins' => 117,
                'fecIni' => $inicio->toDateTimeString(),
                'fecFin' => $fin->toDateTimeString(),
            ]);
