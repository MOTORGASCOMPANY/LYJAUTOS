...
trait VerificaFotosTrait
{
    ...
    {
        $query = Expediente::with(['Inspector', 'Servicio.tipoServicio', 'Archivos.TipoImagen', 'certificacionesExpediente.certificacion']);
        ...
        foreach ($expedientes as $exp) {
            ...
            // IGNORAR EXPEDIENTES ANULADOS
            if ($exp->certificacionesExpediente->isNotEmpty()) {
                $tieneAnulado = $exp->certificacionesExpediente->contains(
                    fn($ce) => optional($ce->certificacion)->estado === 2
                );
