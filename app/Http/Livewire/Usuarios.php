...
class Usuarios extends Component
{
    ...
    protected $rules=[
        ...
        "usuario.dni" => "nullable|string|max:20",
        "usuario.domicilio" => "nullable|string|max:255",
        "usuario.cumpleanos" => "nullable|date",
        "usuario.numero_cuenta"=>"nullable|string|max:50",
        "usuario.asignacion_familiar"=>"nullable",
        "usuario.beneficios" => "nullable",
        "usuario.externo"=>"nullable",
