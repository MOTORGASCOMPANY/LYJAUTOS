...
class ContratosTrabajos extends Component
{
    ...
    public function certificar()
    {
        ...
        if ($contratoExistente) {
            $this->emit("minAlert", ["titulo" => "¡ERROR!", "mensaje" => "Existe un contrato con este inspector.", "icono" => "error"]);
        ...
        try {
            ...
            $this->reset(['idUser', 'fechaInicio', 'fechaExpiracion', 'cargo', 'pago', 'cont_externo']);
