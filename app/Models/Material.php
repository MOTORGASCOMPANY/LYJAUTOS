...
class Material extends Model
{
    ...
    [
        ...
        'numSerie',
        'idUsuario',
        //'stock', NO EXISTE CAMPO
        'estado', // 1-En stock almacen MOTORGAS, 2-En proceso de envio, 3-En poseción de $inspector, 4-Consumido, 5-Anulado, 6-Stock sin firmar
        'ubicacion',
        'grupo',
        'idTipoMaterial',
        'añoActivo',
        //'anio', NO EXISTE CAMPO
        'devuelto', // PARA SI ESTA ESTA ANULADO EL MATERIAL DEBE REGRESAR A OFICINA
        'created_at',
        'updated_at',
    ];
