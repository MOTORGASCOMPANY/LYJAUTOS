...
class Expediente extends Model
{
    ...
    'certificado',
    'fecha',
    'estado', // 1 = Por revisar, 2 = Observado, 3 = Aprobado, 4 = Desaprobado
    'idTaller',
    'idObservacion',
    'usuario_idusuario',
    'servicio_idservicio'
    ...
    public function certificacionesExpediente()
    {
        return $this->hasMany(CertifiacionExpediente::class, 'idExpediente');
    }
