    ...
    <main>
        ...
        <div>
            <p>
                ...
                por Don <strong>Lopez Henriquez Spasoje Bratzo</strong> identificado con DNI 09551431, a quien en adelante
                se denominará EL
        ...
        <table style="width: 100%;">
            <tr>
                <td style="text-align: center;">
                    <img src="{{ public_path('/images/firmaing.jpeg') }}" width="200" height="100" />
                    <h4>_________________________</h4>
                    <h4><strong>Lopez Henriquez Spasoje Bratzo</strong> <br> Gerente General </h4>
                </td>
