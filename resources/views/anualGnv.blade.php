...
<body>
    ...
    <main>
        ...
        <table>
            ...
            <tr>
                ...
                <td>{{-- (isset($carro->largo) ? $largo : 'NE') . ' / ' . (isset($carro->ancho) ? rtrim($carro->ancho, '0') : 'NE') . ' / ' . (isset($carro->altura) ? rtrim($carro->altura, '0') : 'NE') --}}
                    {{ (isset($carro->largo) ? $largo : 'NE') . ' / ' . (isset($carro->ancho) ? $ancho : 'NE') . ' / ' . (isset($carro->altura) ? $altura : 'NE')}}
                </td>
            </tr>
            <tr>
        ...
        <p>Consiste por el presente documento que el sistema de combustible a Gas Natural Vehicular GNV, del vehículo
            ...
            expediente técnico N° {{ $numSerie . ' - ' . $anioSerie }}{{-- $hoja->numSerie . ' - ' . $fechaCert->format('Y') --}} , habilitándose al mismo para cargar Gas Natural
