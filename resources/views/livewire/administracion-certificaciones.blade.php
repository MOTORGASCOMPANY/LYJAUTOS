                                ...
                                <td class="pl-2">
                                    <div class="flex items-center">
                                        @switch($certificacion->Servicio->tipoServicio->id)
                                            ...
                                            @case(5)
                                                {{--@if ($certificacion->modificacionDetalle && $certificacion->modificacionDetalle->tipo_modificacion === 'motor')--}}
                                                @if(!is_null($certificacion->descripcion))
                                    ...
                                    <div class="flex items-center">
                                        <p class="text-sm font-bold  text-indigo-700 ml-2">
                                            ...
                                            @if ($certificacion->Servicio->tipoServicio->id == 11)
                                                ...
                                                --}}
                                                @if (is_null($certificacion->descripcion))
                                                    {{ Str::afterLast($certificacion->UbicacionHoja, '/') ?? 'N.A' }}
                                                @else
                                                    {{ Str::afterLast($certificacion->descripcion, '/') }}
                                                @endif
                                        ...
                                        <div x-show="menu" x-on:click.away="menu = false"
                                            ...
                                            <div class="" role="none">
                                                ...
                                                @if ($certificacion->Servicio->tipoServicio->id == 1 || $certificacion->Servicio->tipoServicio->id == 10 
                                                    || $certificacion->Servicio->tipoServicio->id == 12 || $certificacion->Servicio->tipoServicio->id == 14)
                                ...
                                <td class="pl-4">
                                    <div class="relative flex justify-center px-5">
                                        <div class="inline-block text-left" x-data="{ menu: false }">
                                            ...
                                            <div x-show="menu" x-on:click.away="menu = false"
                                                class="origin-top-right absolute right-12 mt-2 w-44 rounded-md shadow-lg bg-gray-300 ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 focus:outline-none z-40"
                                                ...
                                                <div class="" role="none">
                                                    ...
                                                    @if ($certificacion->Servicio->tipoServicio->id == 11)
                                                        <a wire:click="$emit('verificarCandado', 'deleteCertificacionChip',{{ $certificacion->id }})"
                                                            class="flex px-4 py-2 text-sm text-indigo-700 hover:bg-slate-600 hover:text-white justify-between items-center rounded-md hover:cursor-pointer">
                                                            <i class="fas fa-trash"></i>
                                                            <span> Eliminar Chip</span>
                                                        </a>
                                                    @else
                                                        <a wire:click="$emit('verificarCandado', 'deleteCertificacion',{{ $certificacion->id }})"
                                                            {{--class="flex px-4 py-2 text-sm text-indigo-700 hover:bg-slate-600 hover:text-white justify-between items-center rounded-t-md hover:cursor-pointer"--}}
                                                            class="flex px-4 py-2 text-sm text-indigo-700 hover:bg-slate-600 hover:text-white justify-between items-center rounded-md hover:cursor-pointer">
                                                            <i class="fas fa-trash"></i>
                                                    ...
                                                    {{-- 
                                                    @if ($certificacion->Servicio->tipoServicio->id == 10 || $certificacion->Servicio->tipoServicio->id == 14)
                                                        <a wire:click="$emit('verificarCandado', 'anularCertificacionChip',{{ $certificacion->id }})"
                                                    ...
                                                    @else
                                                        <a wire:click="$emit('verificarCandado', 'anularCertificacion',{{ $certificacion->id }})"
                                                            class="flex px-4 py-2 text-sm text-indigo-700 hover:bg-slate-600 hover:text-white justify-between items-center rounded-b-md hover:cursor-pointer">
                                                            <i class="fas fa-eraser"></i>
                                                            <span>Anular servicio</span>
                                                        </a>
