                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach ($usuarios as $item)
                                        <tr tabindex="0" class="focus:outline-none h-16 border border-slate-300 rounded hover:bg-gray-300">
                                            ...
                                            <td class="pl-12">
                                                <div class="flex items-center">
                                                    <x-jet-checkbox class="h-4 w-4 text-indigo-600 rounded-lg" disabled :checked="$item->externo === 1" />
                                                </div>
                                            </td>
                                            <td class="pl-2">
    ...
    <x-jet-dialog-modal wire:model="editando" wire:loading.attr="disabled">
        ...
        <x-slot name="content">
            ...
            <div class="mb-4">
                ...
                <x-jet-input wire:model="usuario.numero_cuenta" type="text" class="w-full" />
                <x-jet-input-error for="usuario.numero_cuenta" />
            </div>
            <div class="mb-4">
                <x-jet-label value="Domicilio:" />
                <x-jet-input wire:model="usuario.domicilio" type="text" class="w-full" />
                <x-jet-input-error for="usuario.domicilio" />
            </div>
            <div class="mb-4">
                <x-jet-label value="Beneficios:" />
                <x-jet-input wire:model="usuario.beneficios" type="text" class="w-full" />
                <x-jet-input-error for="usuario.beneficios" />
            </div>
            <!-- Email y Celular -->
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div>
                    ...
                    <x-jet-input wire:model="usuario.celular" type="text" inputmode="numeric"
                        maxlength="9" class="w-full" />
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <x-jet-input wire:model="usuario.dni" type="text" maxlength="8" class="w-full" />
                    <x-jet-input-error for="usuario.dni" />
                </div>
                <div>
                    <x-jet-label value="Cumpleaños:" />
                    <x-jet-input wire:model="usuario.cumpleanos" type="date" class="w-full" />
                    <x-jet-input-error for="usuario.cumpleanos" />
                </div>
            </div>           

            <div class="mb-4 w-full flex flex-wrap justify-start items-center gap-4">
                <!-- Checkbox Externo -->
                <div class="w-full md:w-1/3 flex items-center space-x-2">
                    <x-jet-input type="checkbox" wire:model="usuario.externo" value="1" 
                        class="w-4 h-4 text-indigo-600 bg-white border-gray-300 rounded hover:cursor-pointer focus:ring-indigo-600 focus:ring-1 dark:bg-gray-600 dark:border-gray-500"/>
                    <x-jet-label value="Externo" class="text-sm font-medium text-gray-900 select-none hover:cursor-pointer"/>
                    <x-jet-input-error for="usuario.externo" />
                </div>
                <!-- Checkbox Asignación Familiar -->
                <div class="w-full md:w-1/2 flex items-center space-x-2">
                    <x-jet-input type="checkbox" wire:model="usuario.asignacion_familiar" value="1" 
                        class="w-4 h-4 text-indigo-600 bg-white border-gray-300 rounded hover:cursor-pointer focus:ring-indigo-600 focus:ring-1 dark:bg-gray-600 dark:border-gray-500"/>
                    <x-jet-label value="Asignación Familiar S/.113.00" class="text-sm font-medium text-gray-900 select-none hover:cursor-pointer"/>
                    <x-jet-input-error for="usuario.asignacion_familiar" />
                </div>
            </div>
