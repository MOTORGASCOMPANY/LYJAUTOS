                    ...
                    <div class="overflow-x-auto m-auto w-full">
                        <div class="inline-block min-w-full py-2 sm:px-6">
                            <div class="overflow-hidden">
                                <table class="min-w-full border text-center text-sm font-light rounded-xl overflow-hidden" id='data_1'>
                                    ...
                                    <tbody>
                                        @foreach ($aux as $nombre => $servicio)
                                            <tr class="bg-orange-200 hover:bg-orange-300">
                                                ...
                                                @php
                                                    ...
                                                    $porcentajeVentas = $this->totalVentas > 0
                                                        ? ($totalMontoInspector / $this->totalVentas) * 100
                                                        : 0;
                                                    
                                                    // ACUMULADOR
                                                    $totalPorcentajeVentas += $porcentajeVentas;
                                                @endphp
                                                ...
                                                <td class="whitespace-nowrap border-r px-6 py-3">
                                                    {{ number_format($porcentajeVentas, 4) }} %
                                                </td>
                                        ...
                                        <tr class="bg-green-200">
                                            ...
                                            <td class="border-r px-6 py-3 font-bold">
                                                {{ number_format($totalPorcentajeVentas, 4) }} %
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                ...
                <div id='data_2'>
                    ...
                    <div class="bg-gray-200 px-8 py-4 rounded-xl w-full mt-4">                        
                            ...
                            <table class="min-w-full border text-center text-sm font-light rounded-xl overflow-hidden">
                                <thead class="font-medium dark:border-neutral-500">
                                    ...
                                    <tr class="bg-indigo-200">
                                        ...
                                        <th scope="col" class="border-r px-6 py-4">TALLERES</th>
                                        <th scope="col" class="border-r px-6 py-4">ENCARGADOS</th>
                                        <th scope="col" class="border-r px-6 py-4"></th>
                                        <th scope="col" class="border-r px-6 py-4">FAC O BOLT</th>
                                        <th scope="col" class="border-r px-6 py-4">OBSERVACIONES</th>
                                        <th scope="col" class="border-r px-6 py-4">TOTAL</th>
                                        <th scope="col" class="border-r px-6 py-4">% VENTAS</th>
                                    </tr>
                                </thead>
                                @php
                                    $totalPorcentajeSemanales = 0;
                                @endphp
                                <tbody>
                                    @foreach ($semanales as $data)
                                        @php
                                            $porcentajeVentas = $this->totalVentas > 0
                                                ? ($data['total'] / $this->totalVentas) * 100
                                                : 0;

                                            $totalPorcentajeSemanales += $porcentajeVentas;
                                        @endphp
                                    ...
                                    <tr class="bg-green-200">
                                        ...
                                        <td class="border-r px-6 py-3 font-bold">
                                            {{ number_format($totalPorcentajeSemanales, 4) }} %
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                    @foreach ($diarios as $data)
                                        @php
                                            ...
                                            $totalPorcentajeDiarios += $porcentajeVentas;
                                        @endphp
                                        <tr class="bg-orange-200 hover:bg-orange-300">
                                            <td class="whitespace-nowrap border-r px-6 py-3">
                                                {{ $loop->iteration }}
                                    ...
                                    <tr class="bg-green-200">
                                        ...
                                        <td class="border-r px-6 py-3 font-bold">
                                            {{ number_format($totalPorcentajeDiarios, 4) }} %
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        @if ($otros->count())
                            <table class="min-w-full border text-center text-sm font-light rounded-xl overflow-hidden">
                                <thead class="font-medium dark:border-neutral-500">
                                    <tr>
                                        <th colspan="8" class="text-indigo-600 text-xl font-bold">
                                ...
                                <tbody>
                                    @foreach ($otros as $data)
                                        @php
                                            ...
                                            $totalPorcentajeOtros += $porcentajeVentas;
                                        @endphp
                                    ...
                                    <tr class="bg-green-200">
                                        ...
                                        <td class="border-r px-6 py-3 font-bold">
                                            {{ number_format(collect($otros)->sum('total'), 2) }}
                                        </td>
                                        <td class="border-r px-6 py-3 font-bold">
                                            {{ number_format($totalPorcentajeOtros, 4) }} %
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    @if (count($tablaFinalContados) > 0)
                        <div class="bg-gray-200 px-8 py-4 rounded-xl w-full mt-4">
                            <table class="min-w-full border text-center text-sm font-light rounded-xl overflow-hidden">
                                ...
                                @php
                                    $totalPorcentajeContados = 0;
                                @endphp
                                <tbody>
                                    @foreach ($tablaFinalContados as $item)
                                        @php
                                            $porcentajeVentas = $this->totalVentas > 0
                                                ? ($item['total_precio'] / $this->totalVentas) * 100
                                                : 0;

                                            $totalPorcentajeContados += $porcentajeVentas;
                                        @endphp
                                    ...
                                    <tr class="bg-green-200">
                                        ...
                                        <td class="border-r px-6 py-3 font-bold">
                                            S/ {{ number_format(collect($tablaFinalContados)->sum('total_precio'), 2) }}
                                        </td>
                                        <td class="border-r px-6 py-3 font-bold">
                                            {{ number_format($totalPorcentajeContados, 4) }} %
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <div class="bg-gray-200 shadow-md rounded-xl p-4 w-full text-center mt-2">
                        ...
                        <p class="text-sm text-gray-500">EXTERNOS =
                            {{ number_format($aux->flatten(1)->sum('precio'), 2) }} +
                            TALLERES =
                            {{ number_format(collect($semanales)->sum('total') + collect($diarios)->sum('total') + collect($otros)->sum('total'), 2) }}
                            +
                            CONTADOS = {{ number_format(collect($tablaFinalContados)->sum('total_precio'), 2) }}</p>

                        <p class="text-sm font-bold text-gray-700">
                            Total: S/
                            {{ number_format($aux->flatten(1)->sum('precio') + collect($semanales)->sum('total') + collect($diarios)->sum('total') + collect($otros)->sum('total') + collect($tablaFinalContados)->sum('total_precio'), 2) }}
                        </p>
                    </div>
                </div>
            </div>
