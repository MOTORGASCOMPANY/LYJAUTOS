    ...
    <div class="sm:px-6 w-full pt-12 pb-4">
        <div class="bg-gray-200 px-8 py-4 rounded-xl w-full">
            ...
            <div class="flex flex-wrap items-center space-x-2">
                <div class="flex bg-white items-center p-2 w-72 rounded-md mb-4">
                    <span class="mr-2">Tipo:</span>
                    <select wire:model="modo"
                        class="bg-gray-50 border-indigo-500 rounded-md outline-none px-4 py-2 w-full">
                        <option value="taller">Rentabilidad Taller</option>
                        <option value="externo">Rentabilidad Externo</option>
                    </select>
                </div>

                    <div  wire:key="filtro-taller" x-data="tallerFilter" class="flex bg-white items-center p-2 rounded-md mb-4">
                    ...
                    <div wire:key="filtro-inspector" x-data="inspectorFilter" class="flex bg-white items-center p-2 rounded-md mb-4">
        ...
        @if ($ingresosPorTaller)
            <div>
                ...
                <div id='data_1'>
                    ...
                    @php
                        $groupKey = $modo === 'externo' ? 'inspector' : 'taller';
                        $groupLabel = $modo === 'externo' ? 'Inspector' : 'Taller';
                    @endphp
                    ...
                    <div class="bg-gray-200 rounded-md w-full p-4 mt-4">
                        ...
                        <div class="flex items-center mb-0 pl-4">
                            ...
                            {{-- ACTIVAR % ventas--}}
                            <x-jet-label for="gastosAdministrativos" class="mr-2" value="% Ventas" />
                            <x-jet-input type="number" id="gastosAdministrativos" wire:model="gastosAdministrativos"
                                class="w-24 p-2 border border-gray-300 rounded outline-none ml-2 mr-4" />
                                        ...
                                        <tbody>
                                            @foreach ($rentabilidadPorTaller as $key => $rentabilidad)
                                                <tr class="bg-orange-200">
                                                    ...
                                                    <td class="whitespace-nowrap border-r px-6 py-2 font-bold 
