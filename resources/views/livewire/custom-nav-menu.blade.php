                    ...
                    @foreach (Auth()->user()->unreadNotifications as $notification)
                        ...
                        @if ($notification->type == 'App\Notifications\AnulacionSolicitud')
                            <x-jet-dropdown-link href="{{ route('leerAnular', [$notification->id]) }}">
                                <p class="text-xs "> Nueva solicitud de Anulación: <strong class="text-indigo-500">{{ $notification->data['idAnulacion'] }}</strong></p>
                            </x-jet-dropdown-link>
                            <div class="border-t border-gray-100"></div>
                        @endif
                        <!--  Notificacion para Solicitud de Eliminacion(AHORA SERA CANCELAR POR DESISTIMIENTO) -->
                        @if ($notification->type == 'App\Notifications\SolicitudEliminacion')
                            <x-jet-dropdown-link href="{{ route('leerEliminar', [$notification->id]) }}">
                                <p class="text-xs "> Nueva solicitud de Eliminación: <strong class="text-indigo-500">{{ $notification->data['idEliminacion'] }}</strong></p>
                            </x-jet-dropdown-link>
                            <div class="border-t border-gray-100"></div>
                        @endif
                        ...
                        @if ($notification->type == 'App\Notifications\MemorandoSolicitud')
                            <x-jet-dropdown-link href="{{ route('leerMemorando', [$notification->id]) }}">
                                <p class="text-xs "> Nuevo Memorando: <strong class="text-indigo-500">{{ $notification->data['idMemorando'] }}</strong></p>
                                <!-- var_export -->
                            </x-jet-dropdown-link>
                            <div class="border-t border-gray-100"></div>
                        @endif
            ...
            <nav id="sidebar" class="fixed left-0 bottom-0 flex w-3/4 -translate-x-full flex-col bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 pt-2 sm:max-w-xs lg:w-80">
                ...
                <div class="px-4 overflow-y-auto">
                    ...
                    <ul class="text-sm font-medium">
                            ...
                            <li class="text-gray-50 py-3 pl-3 pr-4 hover:bg-gray-600 focus:bg-gray-600 rounded"
                                ...
                                <div x-show.transition="Open" style="display:none;">
                                    <ul x-transition:enter="transition-all ease-in-out duration-300"
                                        ...
                                        @endcan
                                        @can('servicioTemporal')
                                            <li class="transition-colors duration-150">

                                                <x-jet-responsive-nav-link class="text-sm" href="{{ route('servicioTemporal') }}"
                                                    :active="request()->routeIs('servicioTemporal')">
                                                    Servicio Temporal
                                                </x-jet-responsive-nav-link>
                                            </li>
                                        @endcan
                            ...
                            <li class="text-gray-50 py-3 pl-3 pr-4 hover:bg-gray-600 focus:bg-gray-600 rounded"
                                ...
                                <div x-show.transition="Open" style="display:none;">
                                    <ul x-transition:enter="transition-all ease-in-out duration-300"
                                        ...
                                        @endcan
                                        @can('RentabilidadResumen')
                                            <x-jet-responsive-nav-link class="text-sm truncate"
                                                href="{{ route('RentabilidadResumen') }}" :active="request()->routeIs('RentabilidadResumen')">
                        ...
                        {{--           OPCIONES PARA MATERIALES  AL CONTADO        --}}
                        @can('opciones.materialesContado')
                            <li class="text-gray-50 py-3 pl-3 pr-4 hover:bg-gray-600 focus:bg-gray-600 rounded "
                                x-data="{ Open: false }">
                                <div class="inline-flex  items-center justify-between w-full transition-colors duration-150 text-gray-500  cursor-pointer"
                                    x-on:click="Open = !Open">
                                    <span class="inline-flex items-center space-x-6  text-sm  text-white ">
                                        <i class="fa-solid fa-cubes"></i>
                                        <span class="select-none">Materiales Contado</span>
                                    </span>
                                    <i class="fa-solid fa-caret-down ml-1  text-white w-4 h-4" x-show="!Open"></i>
                                ...
                                <div x-show.transition="Open" style="display:none;">
                                    <ul x-transition:enter="transition-all ease-in-out duration-300"
                                        ...
                                        class="mt-2 divide-y-2 divide-gray-600 overflow-hidden text-sm font-medium bg-gray-600 text-white shadow-inner"
                                        aria-label="submenu">
                                        <x-jet-responsive-nav-link class="text-sm" href="{{ route('ListaContados') }}"
                                            :active="request()->routeIs('ListaContados')">
                                            Lista contados
                                        </x-jet-responsive-nav-link>
                                        <x-jet-responsive-nav-link class="text-sm" href="{{ route('FormatosContados') }}"
                                            :active="request()->routeIs('FormatosContados')">
                                            Contados detalles
                                        </x-jet-responsive-nav-link>
                                    </ul>
                        ...
                        @can('opciones.reportesCertificaciones')
                            <li class="text-gray-50 py-3 pl-3 pr-4 hover:bg-gray-600 focus:bg-gray-600 rounded"
                                ...
                                <div class="inline-flex  items-center justify-between w-full  transition-colors duration-150 text-gray-500  cursor-pointer"
                                    ...
                                    <span class="inline-flex items-center space-x-6  text-sm  text-white ">
                                        <i class="fa-solid fa-chart-column"></i>
                                        <span class="select-none">Reportes de Cobranzas</span>
                                    </span>
                                    <i class="fa-solid fa-caret-down ml-1  text-white w-4 h-4" x-show="!Open"></i>
                                ...
                                <div x-show.transition="Open" style="display:none;">
                                    <ul x-transition:enter="transition-all ease-in-out duration-300"
                                        ...
                                        @endcan
                                        @can('reportes.reporteExternosMTG')
                                            <x-jet-responsive-nav-link class="text-sm truncate"
                                                href="{{ route('reportes.reporteExternosMTG') }}" :active="request()->routeIs('reportes.reporteExternosMTG')">
                                                Motorgas Externos
                                            </x-jet-responsive-nav-link>
                                        @endcan
                                        ...
                                        @can('reportes.reporteCalcularChip')
                                            <x-jet-responsive-nav-link class="text-sm truncate"
                                                ...
                                                Motorgas TallerDetllado
                                            </x-jet-responsive-nav-link>
                                        @endcan
                                        @can('reportes.resumenDeben')
                                            <x-jet-responsive-nav-link class="text-sm truncate"
                                                href="{{ route('reportes.resumenDeben') }}" :active="request()->routeIs('reportes.resumenDeben')">
                                                Reporte Deudas 
                                            </x-jet-responsive-nav-link>
                                        @endcan
                                        @can('reportes.resumenDeudas')
                                            <x-jet-responsive-nav-link class="text-sm truncate"
                                                href="{{ route('reportes.resumenDeudas') }}" :active="request()->routeIs('reportes.resumenDeudas')">
                                                Reporte de Deudas 
                                            </x-jet-responsive-nav-link>
                                        @endcan
                                        @can('ListaBoletas')
                        ...
                        {{--           OPCIONES PARA CONSULTA DE MATERIALES Y OTRAS ACCIONES  --}}
                            ...
                            <li class="text-gray-50 py-3 pl-3 pr-4 hover:bg-gray-600 focus:bg-gray-600 rounded"
                                ...
                                <div class="inline-flex  items-center justify-between w-full  transition-colors duration-150 text-gray-500  cursor-pointer"
                                    ...
                                    <span class="inline-flex items-center space-x-6  text-sm  text-white ">
                                        ...
                                        <span class="select-none">Consulta y Acciones </span>
                                    </span>
                                    <i class="fa-solid fa-caret-down ml-1  text-white w-4 h-4" x-show="!Open"></i>
                                ...
                                <div x-show.transition="Open" style="display:none;">
                                    <ul x-transition:enter="transition-all ease-in-out duration-300"
                                        ...
                                        @endcan
                                        @can('reportes.fechaActualizar')
                                            <x-jet-responsive-nav-link class="text-sm truncate"
                                                href="{{ route('reportes.fechaActualizar') }}" :active="request()->routeIs('reportes.fechaActualizar')">
                                                Actualizar fechas
                                            </x-jet-responsive-nav-link>
                                        @endcan                                                                               
                                        @can('reportes.resumenActualizar')
                                            <x-jet-responsive-nav-link class="text-sm truncate"
                                                href="{{ route('reportes.resumenActualizar') }}" :active="request()->routeIs('reportes.resumenActualizar')">
                                                Actualizar deudas
                                            </x-jet-responsive-nav-link>
                                        @endcan
                                        ...
                                        @endcan
                                        @can('reportes.externoActualizar')
                                            <x-jet-responsive-nav-link class="text-sm truncate"
                                                href="{{ route('reportes.externoActualizar') }}" :active="request()->routeIs('reportes.externoActualizar')">
                                                Actualizar externo
                                            </x-jet-responsive-nav-link>
                                        @endcan
                                        ...
                                        @endcan
                                        <x-jet-responsive-nav-link class="text-sm truncate"
                                            href="{{ route('Controlformatos') }}" :active="request()->routeIs('Controlformatos')">
                                            Control de Formatos
                                        </x-jet-responsive-nav-link>
                                        <x-jet-responsive-nav-link class="text-sm truncate"
                                            href="{{ route('InformeCilindros') }}" :active="request()->routeIs('InformeCilindros')">
                                            Información Cilindros
                                        </x-jet-responsive-nav-link>                                                                              
                                        ...
                                        @endcan
                                        @can('reportes.reporteDocumentosEmpleados')
                                            <x-jet-responsive-nav-link class="text-sm truncate"
                                                href="{{ route('reportes.reporteDocumentosEmpleados') }}" :active="request()->routeIs('reportes.reporteDocumentosEmpleados')">
                            ...
                            <li class="text-gray-50 py-3 pl-3 pr-4 hover:bg-gray-600 focus:bg-gray-600 rounded"
                                ...
                                <div x-show.transition="Open" style="display:none;">
                                    <ul x-transition:enter="transition-all ease-in-out duration-300"
                                        ...
                                        @can('Candado')
                                            <x-jet-responsive-nav-link class="text-sm truncate"
                                                href="{{ route('Candado') }}" :active="request()->routeIs('Candado')">
                                                Candado
                                            </x-jet-responsive-nav-link>
                                        @endcan
                                        ...
                                        @can('Planillas')
                                            <x-jet-responsive-nav-link class="text-sm" href="{{ route('Planillas') }}"
                                                :active="request()->routeIs('Planillas')">
                                                Planillas
                                            </x-jet-responsive-nav-link>
                                        @endcan
                                        @can('Gratificaciones')
                                            <x-jet-responsive-nav-link class="text-sm" href="{{ route('Gratificaciones') }}"
                                                :active="request()->routeIs('Gratificaciones')">
                                                Gratificacion
                                            </x-jet-responsive-nav-link>
                                        @endcan
                                        @can('GastosAdministrativos')
                                            <x-jet-responsive-nav-link class="text-sm" href="{{ route('GastosAdministrativos') }}"
                                                :active="request()->routeIs('GastosAdministrativos')">
                                                GastosAdmin
                                            </x-jet-responsive-nav-link>
                                        @endcan
                                        <x-jet-responsive-nav-link class="text-sm" href="{{ route('planilla.comprobantes') }}"
                                            :active="request()->routeIs('planilla.comprobantes')">
                                            Contabilidad Pagos
                                        </x-jet-responsive-nav-link>
                        ...
                        {{--            OPCIONES PARA CONTABILIDAD              --}}
                        @can('opciones.contabilidad')
                            <li class="text-gray-50 py-3 pl-3 pr-4 hover:bg-gray-600 focus:bg-gray-600 rounded"
                                x-data="{ Open: false }">
                                <div class="inline-flex  items-center justify-between w-full  transition-colors duration-150 text-gray-500  cursor-pointer"
                                    x-on:click="Open = !Open">
                                    <span class="inline-flex items-center space-x-6  text-sm  text-white ">
                                        ...
                                        <span class="select-none font">Contabilidad</span>
                                    </span>
                                    <i class="fa-solid fa-caret-down ml-1  text-white w-4 h-4" x-show="!Open"></i>
                                ...
                                <div x-show.transition="Open" style="display:none;">
                                    <ul x-transition:enter="transition-all ease-in-out duration-300"
                                        ...
                                        class="mt-2 divide-y-2 divide-gray-600 overflow-hidden text-sm font-medium bg-gray-600 text-white shadow-inner"
                                        aria-label="submenu">
                                        <x-jet-responsive-nav-link class="text-sm" href="{{ route('Contabilidad') }}"
                        ...
                        @can('opciones.asistencia')
                            <li class="text-gray-50 py-3 pl-3 pr-4 hover:bg-gray-600 focus:bg-gray-600 rounded" x-data="{ Open: false }">
                                <div class="inline-flex  items-center justify-between w-full  transition-colors duration-150 text-gray-500  cursor-pointer"
                                        x-on:click="Open = !Open">
                                        <span class="inline-flex items-center space-x-6  text-sm  text-white ">
                                ...
                                <div x-show.transition="Open" style="display:none;">
                                        <ul x-transition:enter="transition-all ease-in-out duration-300"
                                            ...
                                            @can('dashboardAsistencia')
                                                <x-jet-responsive-nav-link class="text-sm" href="{{ route('dashboardAsistencia') }}"
                                                    :active="request()->routeIs('dashboardAsistencia')">
                                                    Dashboard
                                                </x-jet-responsive-nav-link>
                                            @endcan
                                            @can('horarioEmpleados')
                                                <x-jet-responsive-nav-link class="text-sm" href="{{ route('horarioEmpleados') }}"
                                            ...
                                            @endcan
                                            @can('AsignarHorario')
                                                <x-jet-responsive-nav-link class="text-sm" href="{{ route('AsignarHorario') }}"
                                                    :active="request()->routeIs('AsignarHorario')">
                                                    Horarios Usuarios
                                                </x-jet-responsive-nav-link>
                                            @endcan
                                            @can('autorizarDispositivo')
                                                <x-jet-responsive-nav-link class="text-sm" href="{{ route('autorizarDispositivo') }}"
