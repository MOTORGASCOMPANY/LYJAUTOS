    ...
    @if($chips->count())
            @if($estado=='esperando')
                ...
                <div class="p-4 my-2 flex flex-col md:flex-row justify-evenly items-center">
                    ...
                    <div>
                        <button wire:click="{{ $tipoRegistro == 'consumo' ? 'consumirChip' : 'tramitarChip' }}" wire:loading.attr="disabled"
                            ...
                            <p class="text-sm font-medium leading-none text-white">
                                <span wire:loading wire:target="{{ $tipoRegistro == 'consumo' ? 'consumirChip' : 'tramitarChip' }}">
