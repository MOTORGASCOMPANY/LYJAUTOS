        ...
        @switch($estado)
            @case(1)
                <div class="rounded-xl m-4 bg-white p-8 mx-auto max-w-max shadow-lg">
                    <!-- Selección de inspector y botón para agregar material -->
                    ...
                    <div class="m-4">
                        <!-- Checkbox para mostrar el input de precio -->
                        <div class="flex items-center my-4">
                            <input type="checkbox" id="mostrarPrecio" wire:model="mostrarPrecio"
                                class="mr-2 text-indigo-500 focus:ring-indigo-400 focus:ring-opacity-25 border-gray-300 rounded">
                            <label for="mostrarPrecio" class="text-gray-700">¿Son Formatos al contado?</label>
                        </div>                    
                        <!-- Input de precio condicional -->
                        @if ($mostrarPrecio)
                            <div class="my-4">
                                <x-jet-label for="precio" value="Monto Total:" />
                                <x-jet-input id="precio" type="number" wire:model.defer="precio" step="0.01" min="0"
                                    class="block w-full mt-1" placeholder="Ingrese el monto total" />
