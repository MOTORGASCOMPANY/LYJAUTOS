...
<body>
    ...
    <main>
        ...
        <p>
            ...
            en el expediente técnico N° {{ $numSerie . ' - ' . $anioSerie }}{{-- $numHoja . ' - ' . $fechaCert->format('Y') --}}
        </p>
        ...
        @endif
        <p>
            Habilitandose al mismo para cargar Gas Licuado de Petróleo-GLP hasta el día: {{--08/08/2026--}}
