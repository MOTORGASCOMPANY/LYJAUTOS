...
<body>
    ...
    <main>
        ...
        <h3>CERTIFICADO DE CONFORMIDAD DEL VEHÍCULO CON COMBUSTIÓN DE GLP</h3>
        ...
        <table>
            ...
            <tr>
                ...
                <td>Versión</td>
                <td>{{ isset($carro->version) ? $carro->version : 'NE' }}</td>
        ...
        <p style="font-size:9px;">
            ...
            materia,
            según consta en el expediente técnico <strong>N° {{ $numSerie . ' - ' . $anioSerie }}{{-- $numHoja . ' - ' . $fechaCert->format('Y') --}}</strong>,
            habilitándose al
            mismo tiempo para cargar Gas
            Licuado de Petróleo - GLP hasta el dia :  {{--08/08/2026--}} {{ $fechaCert->format('d/m/') . ($fechaCert->format('Y') + 1) }}
        </p>
        <p>OBSERVACIONES:</p>
        <ol type="1">
            <li>
        ...
        <p>Se expide el presente en la ciudad de Lima, a los {{--08 días del mes de Agosto del 2025.--}}{{ $fecha }}</p>
